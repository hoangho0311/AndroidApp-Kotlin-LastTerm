...
import com.example.lasttermdemo3.databinding.FragmentPumaProductBinding
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.FirebaseDatabase
import com.google.firebase.database.ValueEventListener

class PumaProductFragment : Fragment() {
    private lateinit var binding: FragmentPumaProductBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPumaProductBinding.inflate(layoutInflater)

        cartRef.orderByChild("brand").equalTo("VANS").addValueEventListener(
