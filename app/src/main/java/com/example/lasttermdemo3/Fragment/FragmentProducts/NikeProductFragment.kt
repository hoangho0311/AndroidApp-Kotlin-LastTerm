...
import com.example.lasttermdemo3.databinding.FragmentAllProductBinding
...
class NikeProductFragment : Fragment() {
    private lateinit var binding: FragmentNikeProductBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNikeProductBinding.inflate(layoutInflater)
